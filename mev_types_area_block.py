...
# Aggregate data by date using the mean for each type
...
# Calculate the average MEV transactions per block day
...
# Calculate percentages for each transaction type relative to total MEV transactions
...
plt.legend()
plt.tight_layout()
plt.savefig('figures/mev_types_area_block.png')
# plt.show()
