...
aggregated_data['mev_tx_count'] = aggregated_data[['arb_count', 'liquid_count', 'frontrun_count', 'backrun_count', 'sandwich_count']].sum(axis=1)
...
ax = plt.gca()
ax.xaxis.set_major_locator(mdates.MonthLocator(interval=2))  # Adjust depending on the date range
