...
plt.plot(daily_data_df['date'], daily_data_df['gas_usage_percentage_private'], linestyle='-', color='blue')
plt.title('Daily Gas Used Percentage of Private Transactions Over Time')
plt.xlabel('Date')
plt.ylabel('Percentage of Gas Used by Private Transactions (%)')
...
plt.tight_layout()
plt.savefig('figures/gasused_plot.png')