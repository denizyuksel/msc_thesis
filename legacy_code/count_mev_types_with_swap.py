...
plt.title('Count of Each MEV and Swap Transaction Type Over Time')
plt.xlabel('Date')
plt.ylabel('Count of Type of Transaction per Day')
...
plt.tight_layout()
plt.savefig('figures/count_mev_types_with_swap.png')
# plt.show()
