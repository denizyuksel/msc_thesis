...
plt.plot(daily_data_df['date'], daily_data_df['avg_gas_usage_percentage_private_per_block'], linestyle='-', color='blue')
plt.title('Daily Block Average of Gas Usage Percentage of Private Transactions Over Time')
plt.xlabel('Date')
plt.ylabel('Percentage of Gas Used by Private Transactions per Block (%)')
...
plt.tight_layout()
plt.savefig('figures/gasused_plot_block_avg.png')